pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/henderbl-metallb-deploy'         //do change this
        // Use Jenkins build number as part of the image tag
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/Buddy-Henderson/henderbl-lb-example.git'  //do change this
        
        KUBECONFIG = credentials('henderbl-225')  //do change this
    }
